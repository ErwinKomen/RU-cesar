                ...
                if instance.status == "ini":
                    ...
                    if status == "ok":
                        ...
                        if status == "ok":
                            # Now adapt the form's values
                            form.instance.code = oBack['code']      # Code of the handle
                            form.instance.info = json.dumps(oBack['info'])
                            # Add a note to history
...
#            #    if self.rtype == "json":
#            #        self.template_name = "tsg/tsghandle_edit.html"
#            #    else:
#            #        self.template_name = "tsg/tsghandle_details.html"
#            #if self.rtype == "json":
